...
module Safe.Function.Related.TypeIsomorphisms where

open import Safe.Algebra
import Safe.Algebra.FunctionProperties as FP
import Safe.Algebra.Operations
import Safe.Algebra.RingSolver.Natural-coefficients
open import Safe.Algebra.Structures
open import Safe.Data.Empty
open import Safe.Data.Nat as Nat using (zero; suc)
open import Safe.Data.Product as Prod hiding (swap)
open import Safe.Data.Sum as Sum
open import Safe.Data.Unit
open import Safe.Level as Level hiding (zero; suc)
...
open import Safe.Function.Related as Related
open import Safe.Relation.Binary
open import Safe.Relation.Binary.Product.Pointwise
open import Safe.Relation.Binary.PropositionalEquality as P using (_≡_; _≗_)
open import Safe.Relation.Binary.Sum
open import Safe.Relation.Nullary hiding (module Dec)
open import Safe.Relation.Nullary.Decidable as Dec using (True)
...
private
  ...
  coefficient-dec :
    ...
    let open CommutativeSemiring (×⊎-CommutativeSemiring s ℓ)
        open Safe.Algebra.Operations semiring renaming (_×_ to Times)
    in
...
module Solver s {ℓ} =
  Safe.Algebra.RingSolver.Natural-coefficients
