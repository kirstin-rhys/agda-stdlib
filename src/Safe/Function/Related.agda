...
module Safe.Function.Related where

open import Safe.Level
open import Safe.Function
open import Safe.Function.Equality using (_⟨$⟩_)
open import Safe.Function.Equivalence as Eq      using (Equivalence)
open import Safe.Function.Injection   as Inj     using (Injection; _↣_)
open import Safe.Function.Inverse     as Inv     using (Inverse; _↔_)
open import Safe.Function.LeftInverse as LeftInv using (LeftInverse)
open import Safe.Function.Surjection  as Surj    using (Surjection)
