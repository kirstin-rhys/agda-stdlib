...
module Safe.Function.LeftInverse where
...
open import Safe.Function.Equality as Eq
  using (_⟶_; _⟨$⟩_) renaming (_∘_ to _⟪∘⟫_)
open import Safe.Function.Equivalence using (Equivalence)
open import Safe.Function.Injection using (Injective; Injection)
