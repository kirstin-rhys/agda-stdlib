...
module Safe.Function.Bijection where
...
open import Safe.Function.Injection   as Inj  hiding (id; _∘_)
open import Safe.Function.Surjection  as Surj hiding (id; _∘_)
