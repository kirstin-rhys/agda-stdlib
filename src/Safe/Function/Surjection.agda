...
module Safe.Function.Surjection where

open import Safe.Level
open import Safe.Function.Equality as F
  using (_⟶_) renaming (_∘_ to _⟪∘⟫_)
open import Safe.Function.Equivalence using (Equivalence)
open import Safe.Function.Injection           hiding (id; _∘_)
open import Safe.Function.LeftInverse as Left hiding (id; _∘_)
