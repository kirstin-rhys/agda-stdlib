...
module Safe.Relation.Binary.Product.StrictLex where
...
open import Safe.Relation.Nullary.Sum
open import Safe.Relation.Binary
open import Safe.Relation.Binary.Consequences
open import Safe.Relation.Binary.Product.Pointwise as Pointwise
  using (_×-Rel_)
