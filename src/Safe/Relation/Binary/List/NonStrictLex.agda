...
module Safe.Relation.Binary.List.NonStrictLex where
...
import Safe.Relation.Binary.List.StrictLex as Strict

open import Safe.Relation.Binary.List.Pointwise as Pointwise using ([])
