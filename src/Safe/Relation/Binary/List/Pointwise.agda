...
module Safe.Relation.Binary.List.Pointwise where

open import Safe.Function
open import Safe.Function.Inverse using (Inverse)
open import Safe.Data.Product hiding (map)
open import Safe.Data.List.Base hiding (map)
open import Safe.Level
open import Safe.Relation.Nullary
import Safe.Relation.Nullary.Decidable as Dec using (map′)
open import Safe.Relation.Binary renaming (Rel to Rel₂)
