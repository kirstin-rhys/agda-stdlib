...
module Safe.Relation.Binary.Vec.Pointwise where

open import Safe.Category.Functor
open import Safe.Data.Fin
open import Safe.Data.Nat
open import Safe.Data.Plus as Plus hiding (equivalent; map)
open import Safe.Data.Vec as Vec hiding ([_]; head; tail; map)
import Safe.Data.Vec.Properties as VecProp
open import Safe.Function
open import Safe.Function.Equality using (_⟨$⟩_)
open import Safe.Function.Equivalence as Equiv
  using (_⇔_; ⇔-setoid; module Equivalence)
import Safe.Level as Level
