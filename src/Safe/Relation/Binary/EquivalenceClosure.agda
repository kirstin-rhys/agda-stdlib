...
module Safe.Relation.Binary.EquivalenceClosure where

open import Safe.Data.Star as Star using (Star; ε; _◅◅_; reverse)
open import Safe.Function using (flip; id; _∘_)
open import Safe.Level using (_⊔_)
open import Safe.Relation.Binary
open import Safe.Relation.Binary.SymmetricClosure as SC using (SymClosure)
