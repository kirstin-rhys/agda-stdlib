...
module Safe.Relation.Binary.PropositionalEquality where

open import Safe.Function
open import Safe.Function.Equality using (Π; _⟶_; ≡-setoid)
open import Safe.Data.Product
open import Safe.Data.Unit.NonEta
open import Safe.Level
open import Safe.Relation.Binary
import Safe.Relation.Binary.Indexed as I
open import Safe.Relation.Binary.Consequences
open import Safe.Relation.Binary.HeterogeneousEquality.Core as H using (_≅_)

-- Some of the definitions can be found in the following modules:

open import Safe.Relation.Binary.Core public using (_≡_; refl; _≢_)
open import Safe.Relation.Binary.PropositionalEquality.Core public
