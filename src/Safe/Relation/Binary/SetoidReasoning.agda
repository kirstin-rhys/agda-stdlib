...
-- Example use:
--
--   open import Safe.Data.Maybe
--   import Safe.Relation.Binary.SetoidReasoning as SetR
--
--   begin⟨ S ⟩
--     x
...
open import Safe.Relation.Binary.EqReasoning as EqR using (_IsRelatedTo_)
open import Safe.Relation.Binary
open import Safe.Relation.Binary.Core

open Setoid
module Safe.Relation.Binary.SetoidReasoning where
