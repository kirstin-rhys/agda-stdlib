...
module Safe.Relation.Binary where

open import Safe.Data.Product
open import Safe.Data.Sum
open import Safe.Function
open import Safe.Level
import Safe.Relation.Binary.PropositionalEquality.Core as PropEq
open import Safe.Relation.Binary.Consequences as Consequences
open import Safe.Relation.Binary.Core as Core using (_≡_)
import Safe.Relation.Binary.Indexed.Core as I
