...
module Safe.Relation.Nullary.Decidable where

open import Safe.Data.Bool.Base using (Bool; false; true; not; T)
open import Safe.Data.Empty
open import Safe.Data.Product hiding (map)
open import Safe.Data.Unit
open import Safe.Function
open import Safe.Function.Equality using (_⟨$⟩_; module Π)
open import Safe.Function.Equivalence
  using (_⇔_; equivalence; module Equivalence)
open import Safe.Function.Injection using (Injection; module Injection)
open import Safe.Level using (Lift)
open import Safe.Relation.Binary using (Setoid; module Setoid; Decidable)
