...
module Safe.Algebra.Operations {s₁ s₂} (S : Semiring s₁ s₂) where

open Semiring S renaming (zero to *-zero)
open import Safe.Data.Nat.Base
...
open import Safe.Relation.Binary.PropositionalEquality as PropEq using (_≡_)
