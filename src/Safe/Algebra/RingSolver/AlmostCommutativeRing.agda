...
module Safe.Algebra.RingSolver.AlmostCommutativeRing where
...
import Safe.Algebra.Morphism as Morphism
...
fromCommutativeRing CR = record
  ...
  import Safe.Algebra.Properties.Ring as R; open R ring
  import Safe.Algebra.Properties.AbelianGroup as AG; open AG +-abelianGroup
