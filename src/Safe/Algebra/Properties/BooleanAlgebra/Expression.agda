...
module Safe.Algebra.Properties.BooleanAlgebra.Expression
  {b} (B : BooleanAlgebra b b)
  where

open BooleanAlgebra B

open import Safe.Category.Applicative
import Safe.Category.Applicative.Indexed as Applicative
open import Safe.Category.Monad
open import Safe.Category.Monad.Identity
open import Safe.Data.Fin using (Fin)
open import Safe.Data.Nat
open import Safe.Data.Vec as Vec using (Vec)
open import Safe.Data.Product using (_,_; proj₁; proj₂)
import Safe.Data.Vec.Properties as VecProp
...
open import Safe.Relation.Binary.Vec.Pointwise as PW
