...
module Safe.Algebra.Properties.BooleanAlgebra
         {b₁ b₂} (B : BooleanAlgebra b₁ b₂)
         where

open BooleanAlgebra B
import Safe.Algebra.Properties.DistributiveLattice
private
  open module DL = Safe.Algebra.Properties.DistributiveLattice
                     distributiveLattice public
    hiding (replace-equality)
open import Safe.Algebra.Structures
open import Safe.Algebra.FunctionProperties _≈_
open import Safe.Algebra.FunctionProperties.Consequences
  record {isEquivalence = isEquivalence}
open import Safe.Relation.Binary.EqReasoning setoid
