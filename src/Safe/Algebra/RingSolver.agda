...
module Safe.Algebra.RingSolver
  {r₁ r₂ r₃}
...
import Safe.Algebra.RingSolver.Lemmas as L; open L Coeff R morphism
...
open import Safe.Algebra.Morphism
open _-Raw-AlmostCommutative⟶_ morphism renaming (⟦_⟧ to ⟦_⟧′)
import Safe.Algebra.Operations as Ops; open Ops semiring

open import Safe.Relation.Binary
open import Safe.Relation.Nullary
import Safe.Relation.Binary.EqReasoning as EqR; open EqR setoid
import Safe.Relation.Binary.PropositionalEquality as PropEq
import Safe.Relation.Binary.Reflection as Reflection

open import Safe.Data.Empty
open import Safe.Data.Product
open import Safe.Data.Nat.Base as Nat using (ℕ; suc; zero)
open import Safe.Data.Fin as Fin using (Fin; zero; suc)
open import Safe.Data.Vec
open import Safe.Function
open import Safe.Level using (_⊔_)
