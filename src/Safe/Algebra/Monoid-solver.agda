...
module Safe.Algebra.Monoid-solver {m₁ m₂} (M : Monoid m₁ m₂) where

open import Safe.Data.Fin
import Safe.Data.Fin.Properties as Fin
...
open import Safe.Data.Vec using (Vec; lookup)
open import Safe.Function using (_∘_; _$_)
import Safe.Relation.Binary.EqReasoning
import Safe.Relation.Binary.List.Pointwise as Pointwise
open import Safe.Relation.Binary.PropositionalEquality as P using (_≡_)
import Safe.Relation.Binary.Reflection
...
open module R = Safe.Relation.Binary.Reflection
