...
open import Safe.Data.Bool.Base as Bool using (Bool; true; false; if_then_else_; _∨_)
open import Safe.Data.Fin using (Fin; zero; suc)
open import Safe.Data.Maybe as Maybe
  using (Maybe; decToMaybe; From-just; from-just)
open import Safe.Data.Nat.Base as ℕ using (ℕ; zero; suc; _+_)
open import Safe.Data.Product using (_×_; proj₁; proj₂; uncurry)
open import Safe.Data.Vec using (Vec; []; _∷_; lookup; replicate)

open import Safe.Function using (_∘_)

import Safe.Relation.Binary.EqReasoning   as EqReasoning
import Safe.Relation.Binary.Reflection    as Reflection
import Safe.Relation.Binary.Vec.Pointwise as Pointwise
import Safe.Relation.Nullary.Decidable    as Dec

open import Safe.Relation.Binary.PropositionalEquality as P using (_≡_; decSetoid)
open import Safe.Relation.Nullary using (Dec)
module Safe.Algebra.IdempotentCommutativeMonoidSolver
