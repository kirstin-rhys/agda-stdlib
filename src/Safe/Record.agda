...
open import Safe.Data.Bool.Base using (if_then_else_)
open import Safe.Data.Empty
open import Safe.Data.List.Base
open import Safe.Data.Product hiding (proj₁; proj₂)
...
module Safe.Record (Label : Set) (_≟_ : Decidable (_≡_ {A = Label})) where
