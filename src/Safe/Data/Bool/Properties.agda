...
module Safe.Data.Bool.Properties where

open import Safe.Data.Bool as Bool
...
open import Safe.Relation.Binary.PropositionalEquality as P
  using (_≡_; _≢_; refl)
open P.≡-Reasoning
import Safe.Algebra.FunctionProperties as FP; open FP (_≡_ {A = Bool})
...
commutativeRing-xor-∧ = commutativeRing
  where
  import Safe.Algebra.Properties.BooleanAlgebra as BA
