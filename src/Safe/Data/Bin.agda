...
module Safe.Data.Bin where

open import Safe.Data.Nat as Nat
  using (ℕ; zero; z≤n; s≤s) renaming (suc to 1+_)
open import Safe.Data.Digit
open import Safe.Data.Fin as Fin using (Fin; zero) renaming (suc to 1+_)
open import Safe.Data.Fin.Properties as FP using (_+′_)
open import Safe.Data.List.Base as List hiding (downFrom)
open import Safe.Function
open import Safe.Data.Product using (uncurry; _,_; _×_)
