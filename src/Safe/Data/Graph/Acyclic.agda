...
-- efficient.
module Safe.Data.Graph.Acyclic where

open import Safe.Data.Nat.Base as Nat using (ℕ; zero; suc; _<′_)
import Safe.Data.Nat.Properties as Nat
open import Safe.Data.Fin as Fin
  using (Fin; Fin′; zero; suc; #_; toℕ) renaming (_ℕ-ℕ_ to _-_)
open import Safe.Data.Fin.Properties as FP using (_≟_)
open import Safe.Data.Product as Prod using (∃; _×_; _,_)
open import Safe.Data.Maybe.Base using (Maybe; nothing; just)
open import Safe.Data.Empty
open import Safe.Data.Unit.Base using (⊤; tt)
open import Safe.Data.Vec as Vec using (Vec; []; _∷_)
open import Safe.Data.List.Base as List using (List; []; _∷_)
