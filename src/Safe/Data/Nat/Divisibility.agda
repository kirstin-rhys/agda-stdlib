...
module Safe.Data.Nat.Divisibility where

open import Safe.Data.Nat as Nat
open import Safe.Data.Nat.Properties
open import Safe.Data.Fin using (Fin; zero; suc; toℕ)
import Safe.Data.Fin.Properties as FP
open SemiringSolver
open import Safe.Algebra
open import Safe.Data.Product
open import Safe.Relation.Nullary
open import Safe.Relation.Binary
import Safe.Relation.Binary.PartialOrderReasoning as PartialOrderReasoning
