...
module Safe.Data.Nat.GCD where

open import Safe.Data.Nat
open import Safe.Data.Nat.Divisibility as Div
open import Safe.Relation.Binary
private module P = Poset Div.poset
open import Safe.Data.Product
open import Safe.Relation.Binary.PropositionalEquality as PropEq using (_≡_; subst)
open import Safe.Relation.Nullary using (Dec; yes; no)
open import Safe.Induction
open import Safe.Induction.Nat using (<′-Rec; <′-rec-builder)
open import Safe.Induction.Lexicographic
open import Safe.Function
open import Safe.Data.Nat.GCD.Lemmas
