...
module Safe.Data.Nat.Base where

import Safe.Level as Level using (zero)
open import Safe.Function using (_∘_)
open import Safe.Relation.Binary
open import Safe.Relation.Binary.Core
open import Safe.Relation.Binary.PropositionalEquality.Core
open import Safe.Relation.Nullary using (¬_; Dec; yes; no)
