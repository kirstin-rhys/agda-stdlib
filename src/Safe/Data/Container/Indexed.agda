...
module Safe.Data.Container.Indexed where

open import Safe.Level
open import Safe.Function renaming (id to ⟨id⟩; _∘_ to _⟨∘⟩_)
open import Safe.Function.Equality using (_⟨$⟩_)
open import Safe.Function.Inverse using (_↔_; module Inverse)
open import Safe.Data.Product as Prod hiding (map)
open import Safe.Relation.Unary using (Pred; _⊆_)
open import Safe.Relation.Binary as B using (Preorder; module Preorder)
open import Safe.Relation.Binary.PropositionalEquality as P using (_≡_; _≗_; refl)
open import Safe.Relation.Binary.HeterogeneousEquality as H using (_≅_; refl)
open import Safe.Relation.Binary.Indexed
