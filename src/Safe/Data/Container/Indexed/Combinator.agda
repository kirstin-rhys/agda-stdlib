...
module Safe.Data.Container.Indexed.Combinator where

open import Safe.Level
open import Safe.Data.Container.Indexed
open import Safe.Data.Empty using (⊥; ⊥-elim)
open import Safe.Data.Unit.Base using (⊤)
open import Safe.Data.Product as Prod hiding (Σ) renaming (_×_ to _⟨×⟩_)
open import Safe.Data.Sum renaming (_⊎_ to _⟨⊎⟩_)
open import Safe.Function as F hiding (id; const) renaming (_∘_ to _⟨∘⟩_)
open import Safe.Function.Inverse using (_↔̇_)
open import Safe.Relation.Unary using (Pred; _⊆_; _∪_; _∩_; ⋃; ⋂)
