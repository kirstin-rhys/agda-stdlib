...
module Safe.Data.Bin.Properties where

open import Safe.Data.Bin
open import Safe.Data.Digit using (Bit)
import Safe.Data.Fin as Fin
import Safe.Data.Fin.Properties as 𝔽ₚ
open import Safe.Data.List.Base using (List; []; _∷_)
open import Safe.Data.List.Properties using (∷-injective)
open import Safe.Data.Nat
  using (ℕ; zero; z≤n; s≤s; ≤-pred)
  renaming (suc to 1+_; _+_ to _+ℕ_; _*_ to _*ℕ_)
import Safe.Data.Nat.Properties as ℕₚ
open import Safe.Data.Product using (proj₁; proj₂)
