...
module Safe.Data.Vec.All.Properties where

open import Safe.Data.Vec as Vec using (Vec; []; _∷_; zip; concat; _++_)
open import Safe.Data.Vec.Properties using (map-id; lookup-zip)
open import Safe.Data.Product as Prod using (_×_; _,_; uncurry; uncurry′)
open import Safe.Data.Vec.All as All using (All; All₂; []; _∷_)
open import Safe.Function
open import Safe.Function.Inverse using (_↔_)
open import Safe.Relation.Unary using () renaming (_⊆_ to _⋐_)
open import Safe.Relation.Binary using (REL; Trans)
