...
module Safe.Data.Vec.All where

open import Safe.Data.Vec as Vec using (Vec; []; _∷_; zip)
open import Safe.Data.Vec.Properties using (lookup-zip)
open import Safe.Data.Fin using (Fin; zero; suc)
open import Safe.Function using (_∘_)
open import Safe.Level using (_⊔_)
open import Safe.Data.Product using (uncurry)
...
open import Safe.Relation.Binary.PropositionalEquality using (subst)
