...
module Safe.Data.Vec.Properties where

open import Safe.Algebra
open import Safe.Category.Applicative.Indexed
import Safe.Category.Functor as Fun
open import Safe.Category.Functor.Identity using (IdentityFunctor)
open import Safe.Category.Monad
open import Safe.Category.Monad.Identity
open import Safe.Data.Vec
open import Safe.Data.List.Any using (here; there)
import Safe.Data.List.Any.Membership.Propositional as List
open import Safe.Data.Nat
open import Safe.Data.Nat.Properties using (+-assoc)
open import Safe.Data.Empty using (⊥-elim)
open import Safe.Data.Fin as Fin using (Fin; zero; suc; toℕ; fromℕ)
open import Safe.Data.Fin.Properties using (_+′_)
open import Safe.Data.Product as Prod using (_×_; _,_; proj₁; proj₂; <_,_>)
open import Safe.Function
open import Safe.Function.Inverse using (_↔_)
...
module UsingVectorEquality {s₁ s₂} (S : Setoid s₁ s₂) where
  ...
  import Safe.Data.Vec.Equality as VecEq
...
open import Safe.Relation.Binary.HeterogeneousEquality using (_≅_; refl)
