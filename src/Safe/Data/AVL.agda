...
import Safe.Data.DifferenceList as DiffList
open import Safe.Data.Empty
open import Safe.Data.List.Base as List using (List)
open import Safe.Data.Maybe.Base hiding (map)
open import Safe.Data.Nat.Base hiding (_<_; _⊔_; compare)
open import Safe.Data.Product hiding (map)
open import Safe.Data.Unit
open import Safe.Function
open import Safe.Level using (_⊔_; Lift; lift)
