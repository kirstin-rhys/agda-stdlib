...
module Safe.Data.List.All.Properties where

open import Safe.Data.Bool.Base using (Bool; T)
...
open import Safe.Data.List.All as All using (All; []; _∷_)
open import Safe.Data.List.Any using (Any; here; there)
open import Safe.Data.Nat using (zero; suc; z≤n; s≤s; _<_)
open import Safe.Data.Product as Prod using (_×_; _,_; uncurry; uncurry′)
open import Safe.Function
open import Safe.Function.Equality using (_⟨$⟩_)
open import Safe.Function.Equivalence using (_⇔_; module Equivalence)
open import Safe.Function.Inverse using (_↔_)
open import Safe.Function.Surjection using (_↠_)
open import Safe.Relation.Binary.PropositionalEquality as P using (_≡_)
