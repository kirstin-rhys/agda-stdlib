...
module Safe.Data.List.NonEmpty.Properties where

open import Safe.Category.Monad
open import Safe.Data.List as List using (List; []; _∷_; _++_)
open import Safe.Data.List.NonEmpty as List⁺
open import Safe.Data.List.Properties
