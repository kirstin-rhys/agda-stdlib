...
-- equalities than _≡_.
module Safe.Data.List.Properties where

open import Safe.Algebra
import Safe.Algebra.Monoid-solver
open import Safe.Category.Monad
open import Safe.Data.Bool.Base using (Bool; false; true; not; if_then_else_)
open import Safe.Data.List as List
open import Safe.Data.List.All using (All; []; _∷_)
open import Safe.Data.Maybe.Base using (Maybe; just; nothing)
open import Safe.Data.Nat
open import Safe.Data.Nat.Properties
open import Safe.Data.Product as Prod hiding (map)
...
open import Safe.Relation.Nullary using (yes; no)
open import Safe.Relation.Nullary.Decidable using (⌊_⌋)
open import Safe.Relation.Unary using (Decidable)
...
module List-solver {a} {A : Set a} =
  Safe.Algebra.Monoid-solver (monoid A) renaming (id to nil)
