...
module Safe.Data.List.NonEmpty where

open import Safe.Category.Monad
open import Safe.Data.Bool.Base using (Bool; false; true; not; T)
open import Safe.Data.Bool.Properties
open import Safe.Data.List as List using (List; []; _∷_)
open import Safe.Data.Maybe.Base using (nothing; just)
open import Safe.Data.Nat as Nat
open import Safe.Data.Product using (∃; proj₁; proj₂; _,_; ,_)
open import Safe.Data.Sum as Sum using (_⊎_; inj₁; inj₂)
...
open import Safe.Function.Equivalence
