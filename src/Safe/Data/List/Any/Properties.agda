...
-- related to Any.
module Safe.Data.List.Any.Properties where

open import Safe.Algebra
open import Safe.Category.Monad
open import Safe.Data.Bool.Base using (Bool; false; true; T)
open import Safe.Data.Bool.Properties
open import Safe.Data.Empty using (⊥)
open import Safe.Data.Fin using (Fin) renaming (zero to fzero; suc to fsuc)
open import Safe.Data.List as List
open import Safe.Data.List.Any as Any using (Any; here; there)
open import Safe.Data.List.Any.Membership.Propositional
open import Safe.Data.Nat using (zero; suc; _<_; z≤n; s≤s)
open import Safe.Data.Product as Prod
  using (_×_; _,_; ∃; ∃₂; proj₁; proj₂; uncurry′)
open import Safe.Data.Sum as Sum using (_⊎_; inj₁; inj₂; [_,_]′)
open import Safe.Function
open import Safe.Function.Equality using (_⟨$⟩_)
open import Safe.Function.Equivalence as Eq using (_⇔_; module Equivalence)
open import Safe.Function.Inverse as Inv using (_↔_; module Inverse)
open import Safe.Function.Related as Related using (Related)
open import Safe.Relation.Binary
open import Safe.Relation.Binary.Product.Pointwise
open import Safe.Relation.Binary.PropositionalEquality as P
  using (_≡_; refl; inspect)
open import Safe.Relation.Unary
  using (Pred; _⟨×⟩_; _⟨→⟩_) renaming (_⊆_ to _⋐_)
import Safe.Relation.Binary.Sigma.Pointwise as Σ
open import Safe.Relation.Binary.Sum
open import Safe.Relation.Binary.List.Pointwise
