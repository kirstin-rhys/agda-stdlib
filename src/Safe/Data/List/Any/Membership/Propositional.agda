...
module Safe.Data.List.Any.Membership.Propositional where

open import Safe.Data.Empty
open import Safe.Data.Fin
open import Safe.Function.Inverse using (_↔_)
open import Safe.Function.Related as Related hiding (_∼[_]_)
open import Safe.Data.List.Base as List using (List; []; _∷_)
open import Safe.Data.List.Any using (Any; map)
import Safe.Data.List.Any.Membership as Membership
open import Safe.Data.Product as Prod using (∃; _×_; _,_; uncurry′; proj₂)
open import Safe.Relation.Nullary
open import Safe.Relation.Binary hiding (Decidable)
import Safe.Relation.Binary.InducedPreorders as Ind
open import Safe.Relation.Binary.List.Pointwise as ListEq using ([]; _∷_)
