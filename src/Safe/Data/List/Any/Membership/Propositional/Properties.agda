...
module Safe.Data.List.Any.Membership.Propositional.Properties where
...
import Safe.Function.Injection as Inj
open import Safe.Function.Inverse as Inv using (_↔_; module Inverse)
import Safe.Function.Related as Related
open import Safe.Function.Related.TypeIsomorphisms
...
import Safe.Data.List.Any.Membership.Properties as Membershipₚ
open import Safe.Data.Nat as Nat
...
open import Safe.Relation.Binary.PropositionalEquality as P
  using (_≡_; refl; _≗_)
import Safe.Relation.Binary.Properties.DecTotalOrder as DTOProperties
import Safe.Relation.Binary.Sigma.Pointwise as Σ
open import Safe.Relation.Unary using (_⟨×⟩_)
