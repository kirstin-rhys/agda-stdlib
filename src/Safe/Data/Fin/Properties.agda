...
module Safe.Data.Fin.Properties where

open import Safe.Algebra
open import Safe.Data.Empty using (⊥-elim)
open import Safe.Data.Fin
open import Safe.Data.Nat as N using (ℕ; zero; suc; s≤s; z≤n; _∸_) renaming
  (_≤_ to _ℕ≤_
  ; _<_ to _ℕ<_
  ; _+_ to _ℕ+_)
import Safe.Data.Nat.Properties as N
open import Safe.Data.Product
open import Safe.Function
open import Safe.Function.Equality as FunS using (_⟨$⟩_)
