...
module Safe.Data.Fin.Subset.Properties where

open import Safe.Algebra
import Safe.Algebra.Properties.BooleanAlgebra as BoolProp
open import Safe.Data.Empty using (⊥-elim)
open import Safe.Data.Fin using (Fin; suc; zero)
open import Safe.Data.Fin.Subset
open import Safe.Data.Nat.Base using (ℕ)
open import Safe.Data.Product as Product
open import Safe.Data.Sum as Sum
open import Safe.Data.Vec hiding (_∈_)
...
open import Safe.Relation.Nullary.Negation using (contradiction)
