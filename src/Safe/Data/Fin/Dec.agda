...
module Safe.Data.Fin.Dec where

open import Safe.Function
import Safe.Data.Bool as Bool
open import Safe.Data.Nat.Base hiding (_<_)
open import Safe.Data.Vec hiding (_∈_)
open import Safe.Data.Vec.Equality as VecEq
  using () renaming (module PropositionalEquality to PropVecEq)
open import Safe.Data.Fin
open import Safe.Data.Fin.Subset
open import Safe.Data.Fin.Subset.Properties
open import Safe.Data.Product as Prod
open import Safe.Data.Empty
open import Safe.Function
import Safe.Function.Equivalence as Eq
open import Safe.Relation.Binary as B
...
open import Safe.Relation.Unary as U using (Pred)
